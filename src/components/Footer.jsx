...
export default function Footer() {
  return (
    <footer className="bg-[#1A1A1A] text-[#999999] pt-16 pb-8 text-sm font-sans mt-auto">
      <div className="max-w-[1400px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-gray-400 leading-relaxed max-w-sm">
              Your personal, browser-based PDF utility tool. Built with modern web technologies to merge, split, and compress PDFs securely without server uploads.
            </p>
          </div>

          {/* Section 2: Quick Links */}
          <div className="flex flex-col gap-3">
            <h4 className="text-white font-bold tracking-wider mb-2 text-xs uppercase">Quick Tools</h4>
            ...
            <Link href="/compress-pdf" className="hover:text-white transition">Compress PDF</Link>
            <Link href="/" className="hover:text-white transition">All PDF Tools</Link>
          </div>

          {/* Section 3: Developer Info */}
          <div className="flex flex-col gap-3">
            <h4 className="text-white font-bold tracking-wider mb-2 text-xs uppercase">Developer Profile</h4>
            <div className="bg-[#222222] p-4 rounded-lg border border-[#333333]">
              <p className="text-white font-semibold text-base mb-1">Suhel Ansari</p>
              <p className="text-gray-400 text-xs mb-3">B.Tech Computer Science & Engineering (2nd Year)</p>
              <p className="text-gray-300 text-sm flex items-center gap-2">
                <span className="text-[#25D366] font-bold">WhatsApp:</span> +91 9335067990
              </p>
            </div>
          </div>
        ...
        {/* Bottom Area: Copyright & Social Logos (Using direct SVGs for zero errors) */}
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-5">
            ...
            {/* LinkedIn Logo */}
            <a href="https://linkedin.com/in/" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-[#0A66C2] transition-colors" aria-label="LinkedIn">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
            </a>

            {/* Instagram Logo */}
            <a href="https://instagram.com/" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-[#E1306C] transition-colors" aria-label="Instagram">
