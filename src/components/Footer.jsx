          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10 mb-12">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-3">
                ...
                <a href="https://github.com/ansarisuhel4505" target="_blank" rel="noreferrer" className="flex items-center gap-3 text-gray-400 hover:text-white transition-colors">
                ...
                <a href="https://www.linkedin.com/in/suhel-ansari-6a361b412/?lipi=urn%3Ali%3Apage%3Ap_mwlite_my_network%3BmpBmcrpmQpKEkqCIdNb3ew%3D%3D" target="_blank" rel="noreferrer" className="flex items-center gap-3 text-gray-400 hover:text-[#0A66C2] transition-colors">
