...
const TOOL_TITLE = "Excel to PDF";
const TOOL_DESC = "Convert your Excel spreadsheets to PDF.";
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-[#F5F5F7]">
      ...
      <Head>
        ...
        <meta property="og:title" content="Convert Excel to PDF Online Free | MasterPdf" />
        <meta property="og:description" content="Fastest and most secure way to convert Excel (XLS, XLSX) to PDF online." />
      </Head>
