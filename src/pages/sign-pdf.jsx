               ...
               <div className="ml-6 flex-1 max-w-sm hidden sm:block relative">
                 ...
                 {showFileDropdown && (
                   <div className="absolute top-full left-0 mt-1 w-full bg-white border border-gray-200 shadow-lg rounded z-50">
                     {files.map((f, i) => (
                       <div key={i} onClick={() => { setActiveFileIndex(i); setShowFileDropdown(false); setCurrentPage(1); }} className={`p-2 text-sm font-bold cursor-pointer hover:bg-red-50 hover:text-[#E5322D] truncate ${i === activeFileIndex ? 'text-[#E5322D] bg-red-50/50' : 'text-gray-700'}`}>
                         {f.name}
                       </div>
                     ))}
                   </div>
              ...
              <div className="w-full lg:w-[320px] bg-white flex flex-col h-full shrink-0 shadow-[-5px_0_15px_rgba(0,0,0,0.05)] z-20">
                ...
                <div className="p-5 overflow-y-auto flex-grow custom-scrollbar">
                  ...
                  <div className="mb-8">
                    ...
                    <div onClick={() => addElement('signature')} className="border border-[#E5322D] border-dashed rounded-lg p-0 bg-white hover:bg-gray-50 cursor-pointer flex items-center justify-between group transition-colors shadow-sm overflow-hidden min-h-[60px]">
                  ...
                  <div className="border-t border-gray-200 pt-6 mb-4">
                    <label className="flex items-start gap-3 cursor-pointer group">
                      ...
                      <div>
                        <div className="flex items-center gap-2 font-bold text-gray-800 group-hover:text-[#E5322D] transition-colors"><Lock size={16} className="text-gray-400 group-hover:text-[#E5322D]"/> Lock document</div>
                        <p className="text-xs text-gray-500 mt-1">Prevents further editing after you sign.</p>
                      </div>
                    </label>
                  </div>
                </div>
